  ...
  const benefits = [
    {
      ...
      description: "Fast loading and delivery for time-sensitive shipments"
    },
    {
      icon: MapPin,
      title: "Local Expertise",
      description: "Deep knowledge of local markets and optimal routes"
    },
    {
      icon: DollarSign,
      title: "Consistent Revenue",
      description: "Steady income from high-demand local deliveries"
    }
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            ...
            <h1 className="text-5xl lg:text-6xl font-bold mb-6">
              <span className="gradient-text">Box Truck</span> Dispatch Services
            </h1>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed mb-8">
              Perfect for local and regional deliveries with maximum flexibility. 
              Get consistent loads and build lasting relationships with local shippers.
            </p>
            <Button 
              size="lg" 
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
              ...
              <div className="card-gradient border border-border/20 rounded-2xl p-8">
                ...
                <h3 className="text-xl font-bold mb-4">Box Truck Specifications</h3>
                <div className="space-y-3 text-sm text-muted-foreground">
                  <div className="flex justify-between">
                    <span>Length:</span>
                    <span className="text-foreground">26 feet</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Cargo Volume:</span>
                    <span className="text-foreground">1,400 cu ft</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Max Weight:</span>
                    <span className="text-foreground">26,000 lbs</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Ideal Range:</span>
                    <span className="text-foreground">Local - 300 miles</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center card-gradient border border-border/20 rounded-2xl p-12">
            <h3 className="text-3xl font-bold mb-4 gradient-text">
              Ready to Start Box Truck Dispatch?
            </h3>
            <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
              Join our network of successful box truck drivers. Get consistent loads, 
              competitive rates, and dedicated support for your local delivery business.
            </p>
