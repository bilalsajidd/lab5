...
const Hotshot = () => {
  ...
  const benefits = [
    ...
    },
    {
      icon: DollarSign,
      title: "Premium Rates",
      description: "Higher per-mile rates due to expedited service requirements"
    },
    {
      icon: Zap,
      title: "Quick Response",
      description: "Fast dispatch and immediate availability for emergency loads"
    }
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            ...
            <h1 className="text-5xl lg:text-6xl font-bold mb-6">
              <span className="gradient-text">Hotshot</span> Dispatch Services
            </h1>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed mb-8">
              Expedited delivery for time-sensitive shipments. Premium rates for urgent loads 
              that need immediate pickup and fast delivery across the country.
            </p>
            <Button 
              size="lg" 
              className="bg-gradient-primary hover:opacity-90 transition-opacity glow-effect px-8"
            >
              Start Hotshot Dispatch
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
              ...
              <div className="card-gradient border border-border/20 rounded-2xl p-8">
                ...
                <h3 className="text-xl font-bold mb-4">Hotshot Specifications</h3>
                <div className="space-y-3 text-sm text-muted-foreground">
                  <div className="flex justify-between">
                    <span>Vehicle Type:</span>
                    <span className="text-foreground">Pickup + Trailer</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-foreground">USA & Canada</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center card-gradient border border-border/20 rounded-2xl p-12">
            <h3 className="text-3xl font-bold mb-4 gradient-text">
              Ready to Start Hotshot Dispatch?
            </h3>
            <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
              Join the fast-paced world of expedited freight. Get premium rates for urgent loads 
              and build a reputation for reliable, time-critical delivery service.
            </p>
